...
model.add(kr.layers.Dense(16, input_shape=(4,), kernel_regularizer=kr.regularizers.l2(0.001)))
# Apply the sigmoid activation function to that layer.
model.add(kr.layers.Activation("relu"))
model.add(kr.layers.Dropout(0.25))
model.add(kr.layers.Dense(16, kernel_regularizer=kr.regularizers.l2(0.001)))
model.add(kr.layers.Activation("relu"))
model.add(kr.layers.Dropout(0.25))
